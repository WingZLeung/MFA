...
def UAS_labels(UAS_p):
    ...
    labels = pd.read_csv("/jmain02/home/J2AD003/txk81/wxl53-txk81/corpora/UASnew/UA_speech_labels.csv")   
...
corp_path = "/jmain02/home/J2AD003/txk81/wxl53-txk81/corpora"

OUT = "/jmain02/home/J2AD003/txk81/wxl53-txk81/MFA_output/corpora/"

UAS_root = f"{corp_path}/UASnew/dysarthria/"
UASC_root = f"{corp_path}/UASnew/control/"
...
root = f"{corp_path}/Torgo_use/"
root_con = f"{corp_path}/TORGO_control/"
